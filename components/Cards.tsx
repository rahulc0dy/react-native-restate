  ...
  return (
    ...
    >
      ...
      <View className="flex flex-col items-start absolute bottom-5 inset-x-5">
        ...
        <Text className="text-base rounded-tr-sm text-white">22 W 15th St, New Jersey</Text>
  ...
  return (
    ...
    >
      ...
      <View className="flex flex-col mt-2">
        ...
        <Text className="text-xs font-rubik text-black-200">22 W 15th St, New Jersey</Text>
